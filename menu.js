...
const DISHES = [
    ...
    {num: 3, name:'Pad Kha Pao', thai:'Basil', cat:'stirfried', img: 'pad kha pao (basil).jpg',
     ...
     price:14.90, estimate: true, desc: 'Stir fried garlic, pepper sauce and vegetables. Choose your protein.', spice:1, veg:false},
     ...
     price:14.90, estimate: true, desc: 'Stir fried with chilli jam, onion, mixed vegetables and cashew nuts. Choose your protein.', spice:1, veg:false},
     {num: 9, name:'Pad Takrai', thai:'Lemongrass', cat:'stirfried', img: 'pad takrai (lemongrass).jpg',
     price:14.90, estimate: true, desc: 'Stir fried with lemongrass, chilli jam and mixed vegetables. Choose your protein.', spice:1, veg:false},
     ...
     price:12.90, desc: 'Steamed mixed vegetables and tofu topped with satay sauce.', spice:0, veg:true},
     ...
     price:14.90, estimate: true, desc: 'Thai red curry infused with coconut milk, fresh vegetables, bamboo shoots and basil leaves. Choose your protein.', spice:2, veg:false},
     {num: 17, name:'Yellow Curry', thai:'', cat:'curry', img: 'thai yellow curry.jpg',
     price:14.90, estimate: true, desc: 'Thai yellow curry cooked with coconut milk and vegetables. Choose your protein.', spice:1, veg:false},
     {num: 18, name:'Panang Curry', thai:'', cat:'curry', img: 'thai Panang Curry.webp',
     price:14.90, estimate: true, desc: 'Mild curry cooked with coconut milk and vegetables. Choose your protein.', spice:1, veg:false},
     {num: 19, name:'Massaman Curry Beef', thai:'', cat:'curry', img: 'Massaman Curry Beef.jpeg', 
     price:14.90, desc: 'Chunky tender beef stewed in sweet curry paste sauce with potato and peanut.', spice:1, veg:false},
     ...
     price:17.90, desc: 'Famous Thai aromatic soup with prawn, mushroom, lemongrass and a touch of chilli.', spice:2, veg:false},
     {num: 22, name:'Tom Kha Gai', thai:'', cat:'soup', img: 'Tom Kha Gai.jpg',
     price:15.90, desc: 'Creamy aromatic soup with mushroom, chicken and coconut-cream, flavoured with kaffir lime leaf and galangal.', spice:1, veg:false},
     {num: 23, name:'Tom Po Tak', thai:'', cat:'soup', img:'Tom Po Tak.jpg', 
     price:8.90, desc: 'Mixed seafood soup with lemon juice, Thai herbs, mushroom and basil.', spice:2, veg:false},
     ...
     price:12.90, estimate: true, desc: 'Fried rice with pineapple, curry powder and cashew nut. Choose your protein.', spice:0, veg:false},
